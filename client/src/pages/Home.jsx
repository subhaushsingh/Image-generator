...
const fetchPosts = async () => {
  ...
  try {
    ...
    alert(error.message || "Something went wrong while fetching posts.");
  } finally {
    setLoading(false);
  }
};
  ...
  return (
    <section className='max-w-7xl mx-auto'> 
      <div >
        ...
        <p className='mt-2 text-[16px]  max-w-[675px] text-[#222328]'>Browse through  a collection of imaginative and visually stunning images generated by AI.</p>
      </div>
